...
def transform_data(customers, employees, movies, rentals):
    ...
    customers.to_csv("etl/cleaned_customer.csv", index=False)
    ...
    employees["job_role"] = employees["job_role"].fillna("Not Assigned")
    ...
    employees.to_csv("etl/cleaned_employee.csv", index=False)
    ...
    movies.to_csv("etl/cleaned_movie.csv", index=False)
    ...
    rentals.to_csv("etl/cleaned_rental.csv", index=False)
